...
public class QuestionCommentController {
	...
	public String addComment(@ModelAttribute("newComment") QuestionComment comment, 
							@RequestParam int question_id, HttpSession session) {
	...
	public String deleteComment(HttpServletRequest request, HttpSession session,
	    ...
	    if (comment != null && comment.getMember().getMember_id() == member.getMember_id()) {
	        ...
	        // Check if the comment is actually deleted
